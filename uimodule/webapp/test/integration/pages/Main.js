sap.ui.require(["sap/ui/test/Opa5", "sap/ui/test/actions/Press"], function (Opa5, Press) {
    ...
    Opa5.createPageObjects({
        onTheMainPage: {
            viewName: "com.personal.portfolio.view.MainView",
            ...
            assertions: {
                ...
                iShouldSeeTheTitle: function () {
                    return this.waitFor({
                        ...
                        properties: {
                            text: "Title of com.personal.portfolio",
                        },
                        success: function () {
                            Opa5.assert.ok(true, "The page shows the correct title");
                        },
                        errorMessage: "App does not show the expected title com.personal.portfolio",
                    });
                },
            },
        },
